...
$start = $_GET['start'];
$end = $_GET['end'];
$query = mysqli_query($koneksi,"SELECT * FROM tb_masuk a INNER JOIN tb_barang b ON a.barang_id=b.id_brg WHERE a.tgl_masuk BETWEEN '$start' AND '$end' ORDER BY a.tgl_masuk DESC") or die(mysqli_error($koneksi));
